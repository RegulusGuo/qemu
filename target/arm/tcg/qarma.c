...
qkey_t forward_update_key(qkey_t T) {
	// printf("[qemu] in forward_update_key\n");
...
qkey_t backward_update_key(qkey_t T) {
	// printf("[qemu] in backward_update_key\n");
	cell_t cell[16], temp[16];
	text2cell(cell, T);
...
text_t __attribute__((optimize("O0"))) qarma64_enc(text_t plaintext, tweak_t tweak, qkey_t w0, qkey_t k0, int rounds) {
...
text_t __attribute__((optimize("O0"))) qarma64_dec(text_t plaintext, tweak_t tweak, qkey_t w0, qkey_t k0, int rounds) {
